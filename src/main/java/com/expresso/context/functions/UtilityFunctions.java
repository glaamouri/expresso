...
public class UtilityFunctions implements FunctionProvider {
    ...
    public void registerFunctions(Context context) {
        context.registerFunction("typeof", args -> {
            ...
            if (args[0] instanceof Boolean)
                return "boolean";
            if (args[0] instanceof List || args[0].getClass().isArray())
                return "list";
    ...
    public List<FunctionInfo> getFunctionInfo() {
        return List.of(
                FunctionInfo.builder("typeof")
                        .description("Returns the type of a value as a string")
                        .parameter("value", "Object", "The value to check")
                        .returnType("String")
                        .build(),

                FunctionInfo.builder("toString")
                        .description("Converts a value to a string")
                        .parameter("value", "Object", "The value to convert")
                        .returnType("String")
                        .build(),

                FunctionInfo.builder("toNumber")
                        .description("Converts a value to a number")
                        .parameter("value", "Object", "The value to convert")
                        .returnType("Number")
                        .build(),

                FunctionInfo.builder("toBoolean")
